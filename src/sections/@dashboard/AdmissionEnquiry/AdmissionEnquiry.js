...
export default function AdmissionEnquiry() {
  ...
  const handleDeleteClick = (row) => () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://academia-master-api.onrender.com/api/studentenquiry/${row.row._id}`).then((r) => {
  ...
  useEffect(() => {
    axios.get('https://academia-master-api.onrender.com/api/studentenquiry').then((r) => {
